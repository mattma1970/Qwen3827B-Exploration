...
// Official Canva wordmark SVG (brand gradient: purple #6420FF/#7D2AE7 -> teal #00C4CC),
// embedded as a data-URI image. Loaded once at boot; pill falls back to the "C" mark
// until it is ready (or when Image is unavailable, e.g. headless tests).
